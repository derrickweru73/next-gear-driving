      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl shadow-lg p-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500">Theory Examination Summary</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-10">
            ...
            <div className="bg-slate-50 rounded-xl p-6">
              ...
              <p className="text-3xl font-bold mt-3">{percentage}%</p>
            </div>
            ...
            {result.passed ? (
              <div className="bg-green-50 border border-green-200 rounded-xl p-6">
                ...
                <p className="mt-4 text-gray-700">
                  You successfully passed the theory assessment. Practical
                  driving lessons are now unlocked.
                </p>
              </div>
            ) : (
              <div className="bg-red-50 border border-red-200 rounded-xl p-6">
                ...
                <p className="mt-4 text-gray-700">
                  You did not reach the required passing mark. Review your
                  lessons and retake the assessment.
                </p>
              </div>
            )}
          </div>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <h3 className="text-xl font-bold mt-5">Next Step</h3>
