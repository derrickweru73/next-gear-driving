      ...
      <main className="flex-1 px-10 py-12">
        ...
        <div className="grid lg:grid-cols-4 gap-6 mt-10">
          <div className="bg-white rounded-2xl shadow p-6 border-l-4 border-[#F97316]">
            ...
            <h2 className="text-3xl font-bold mt-4">70%</h2>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="h-3 rounded-full bg-gray-200">
                  <div className="h-3 w-[70%] rounded-full bg-[#F97316]" />
                </div>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow p-8">
            ...
            <div className="rounded-xl border p-5">
              ...
              <p className="text-gray-600 mt-3 leading-7">
                Finish all theory topics and pass your quizzes before booking
                your practical driving lessons.
              </p>
